        ...
        return t.forEach(function(r, e) {
            ...
            if (t = u[f])
                ...
                i[t.start] = u[t.end] = t;
                    ...
                    if (delete i[t.start], t.unshift(n)
                        , t.start = f, e = u[f]) {
                delete u[e.end];
    ...
    return e.forEach(function(n) {
        ...
        type: "MultiPolygon", arcs: a.map(function(e) {
            ...
            if (e.forEach(function(n) {
                ...
                , (n = o.length) > 1)for (var u, c = i(e[0][0]), a = 0; n > a; ++a)
                if (c === i(o[a])) {
                    u = o[0], o[0] = o[a], o[a] = u;
                    break
                }
...
function v() {
    ...
    function t(n, t) {
        for (; ;) {
            ...
            if (o > i && p(e[i], f) < 0 && (f = e[u = i]), o > r && p(e[r], f) < 0 && (f = e[u = r])
                , u === t)break;
